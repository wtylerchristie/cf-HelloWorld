...
content = '<h1>Hello World! Just another hello from <b>Tyler Christie</b></h1></br>I am instance <strong>#' + str(app_instance) + '</strong> serving application <strong>' + app_name + '</strong> with GUID <strong> ' + app_guid + ' !'
